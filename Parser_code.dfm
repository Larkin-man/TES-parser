object Form1: TForm1
  ...
  object PanelPRO: TPanel
    ...
    object FlowPanel1: TFlowPanel
      ...
      object FindinSublists: TButton
        ...
        Width = 173
        Height = 32
        Hint = 'Find in selected sublists'
        Margins.Left = 4
        Margins.Top = 4
        Margins.Right = 4
        Margins.Bottom = 4
      ...
      object DelGroupSubheaders: TButton
        ...
        Height = 32
        Hint = 
          'Deletes group of lines since the specified Heading and up to the' +
          ' following Heading'
        Margins.Left = 4
        Margins.Top = 4
        Margins.Right = 4
        Margins.Bottom = 4
        Caption = 'Delete group subheaders'
        Enabled = False
        ParentShowHint = False
        ShowHint = True
        TabOrder = 30
      ...
      object LoadCells: TButton
        ...
        Height = 32
        Hint = 
          'Loads the exported cells for start of other function (Check CELL' +
          ')'
        Margins.Left = 4
        Margins.Top = 4
        Margins.Right = 4
  ...
  object ImageList1: TImageList
    ...
    Top = 128
    Bitmap = {
      494C010105000A00180210001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
